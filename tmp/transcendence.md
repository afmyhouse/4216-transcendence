...
>>[!IMPORTANT] Again, some of these contraints could be overriden by the choice of specific modules.
...
the programming language used for smart contract development.
    ...
    risks associated with a live blockchain.
...
>[!WARNING]
>Attention: You will need to explain in detail how your AI is working during your evaluation. Creating an AI that does nothing is strictly prohibited; it must have the capability to win occasionally.
